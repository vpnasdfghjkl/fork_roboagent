...
def build_ACT_model_and_optimizer(args_override):
    ### args_override:{'lr': 1e-05, 'num_queries': 20, 'kl_weight': 10, 'hidden_dim': 512, 'dim_feedforward': 1600, 'lr_backbone': 1e-05, 'backbone': 'resnet18', 'enc_layers': 4, 'dec_layers': 7, 'nheads': 8, 'camera_names': ['rgb_left', 'rgb_top', 'rgb_right', 'rgb_wrist']}
